<?php 
 ...
 if(isset($_POST ['sign_up'])){
 	...
 	$rand= rand(1, 2 );
 	if($name == ''){
 		echo"<script>alert('You cannot leave name field empty')</script>";
 	}
 	...
 	if($rand == 1)
 		$profile_pic ="images/1.jpeg";
 	
 	else if ($rand == 2)
 		$profile_pic ="images/2.jpeg";
 	...
 	if($query){
 		echo"<script>alert('You have successsfully registred.')</script>";
